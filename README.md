...
Number of operations environment is called computational model which is a mathematical abstraction used to measure the time complexity.
The most popular model of computational model is RAM model.

### Time complexity
It has two cases best and worst case which indicates how nearly the algorithms operations will be
The best case called omega notation which is the lower bound of the complexity that shows the algorithm is not faster than

We only care about the worst case also called Big O notation which is the upper bound of the complexity to prove that the algorithms is not slower than
